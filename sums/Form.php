...
EOD;
    ...
    protected function uploader($name = null, $value, $inputAttr = [], $uploadAttr = [], $chooseAttr = [], $previewAttr = [])
    {
        ...
        $uploadBtn = $upload ? $this->button('<i class="fa fa-upload"></i> ' . SoLan('Upload'), array_merge($options, $uploadAttr)) : '';
        $options = [
            'id'            => "fachoose-{$domname}",
        ...
        $chooseBtn = $choose ? $this->button('<i class="fa fa-list"></i> ' . SoLan('Choose'), array_merge($options, $chooseAttr)) : '';
